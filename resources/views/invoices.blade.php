...
<!-- Mirrored from zawiastudio.com/dashboard/demo/invoices.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Nov 2017 15:23:38 GMT -->
<head>
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>Invoices | Dashboard UI Kit</title>
                        ...
                        <div class="c-card u-mb-medium">
                            <div class="c-card__head">
                                <h3 class="c-card__title">Monthly Summary
                                    <span class="u-block u-text-mute u-text-xsmall">February 2017 (12 Days Remaining)</span>
                                </h3>
                                ...
                                <div class="c-card__icon">
                                    ...
                                    <div class="c-dropdown__menu dropdown-menu dropdown-menu-right" aria-labelledby="dropdwonMenuCard1">
                    ...
                    <div class="col-lg-4">
                        <div class="c-card u-p-medium u-mb-medium">
                            ...
                            <div class="c-card__icon">
                                ...
                                <div class="c-dropdown__menu dropdown-menu dropdown-menu-right" aria-labelledby="dropdwonMenuCard2">
                                    <a class="c-dropdown__item" href="#">Link 1</a>
                                    <a class="c-dropdown__item" href="#">Link 2</a>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="c-card u-mb-large">
                            <div class="c-card__head">
                                <h3 class="c-card__title">Invoicing</h3>
                            </div>
