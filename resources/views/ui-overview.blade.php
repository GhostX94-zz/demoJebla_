...
<!-- Mirrored from zawiastudio.com/dashboard/demo/ui-overview.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Nov 2017 15:23:43 GMT -->
<head>
        <meta charset="utf-8">
            ...
            <div class="row">
                <div class="col-sm-6 col-md-3 u-mb-small">
                    <div class="c-field has-addon-left">
                        ...
                        <input class="c-input" id="input9" type="text" placeholder="Clark">
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-md-3 u-mb-small">
                    <div class="c-field has-icon-right">
                        ...
                        <input class="c-input" id="input12" type="text" placeholder="Clark">
                    </div>
                </div>
            </div><!-- // .row -->
                        ...
                        <div class="col-md-4 u-text-center u-mb-medium">
                            <div class="c-dropdown dropdown">
                                <div class="c-avatar has-dropdown dropdown-toggle" id="dropdownMenuButton2" data-toggle="dropdown" role="menu" aria-haspopup="true" aria-expanded="false">
                                    <img class="c-avatar__img" src="http://i.pravatar.cc/150?img=30" alt="Name">
                                </div>
                        ...
                        <div class="col-md-4 u-text-center u-mb-medium">
                            <div class="c-dropdown dropdown">
                                <div class="c-avatar has-dropdown dropdown-toggle" id="dropdownMenuButton3" data-toggle="dropdown" role="menu" aria-haspopup="true" aria-expanded="false">
                                    <img class="c-avatar__img" src="http://i.pravatar.cc/72?img=41" alt="Name">
                                </div>
...
<!-- ============================== ALERTS ================================= -->
            ...
            <div class="row u-mb-xlarge">
                ...
                <div class="col-lg-4">
                    <h4 class="u-mb-medium">Calendar</h4>

                    <div class="c-calendar">
                        <nav class="c-calendar__nav">
                            <a href="#" class="c-calendar__control">
                                <i class="fa fa-caret-left"></i>
                            </a>
                            <strong class="c-calendar__header">August 2017</strong>
                            <a href="#" class="c-calendar__control">
                        ...
                        <table class="c-calendar__picker">
                            <thead>
                                <tr>
                                    <th class="c-calendar__day"><abbr title="Sunday">Sun</abbr></th>
                                    <th class="c-calendar__day"><abbr title="Monday">Mon</abbr></th>
                                    <th class="c-calendar__day"><abbr title="Tuesday">Tue</abbr></th>
                                    <th class="c-calendar__day"><abbr title="Wednesday">Wed</abbr></th>
                                    <th class="c-calendar__day"><abbr title="Thursday">Thu</abbr></th>
                                    <th class="c-calendar__day"><abbr title="Friday">Fri</abbr></th>
                                    <th class="c-calendar__day"><abbr title="Saturday">Sat</abbr></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td class="c-calendar__date is-disabled">28</td>
                                    <td class="c-calendar__date is-disabled">29</td>
                                    <td class="c-calendar__date is-disabled">30</td>
                                    <td class="c-calendar__date is-disabled">31</td>
                                    <td class="c-calendar__date">1</td>
                                    <td class="c-calendar__date">2</td>
                                    <td class="c-calendar__date">3</td>
                                </tr>
                                <tr>
                                    <td class="c-calendar__date">4</td>
                                    <td class="c-calendar__date">5</td>
                                    <td class="c-calendar__date">6</td>
                                    <td class="c-calendar__date is-active">7</td>
                                    <td class="c-calendar__date">8</td>
                                    <td class="c-calendar__date">9</td>
                                    <td class="c-calendar__date">10</td>
                                </tr>

                                <tr>
                                    <td class="c-calendar__date">11</td>
                                    <td class="c-calendar__date">12</td>
                                    <td class="c-calendar__date">13</td>
                                    <td class="c-calendar__date">14</td>
                                    <td class="c-calendar__date">15</td>
                                    <td class="c-calendar__date">16</td>
                                    <td class="c-calendar__date">17</td>
                                </tr>

                                 <tr>
                                    <td class="c-calendar__date">18</td>
                                    <td class="c-calendar__date">19</td>
                                    <td class="c-calendar__date">20</td>
                                    <td class="c-calendar__date">21</td>
                                    <td class="c-calendar__date">22</td>
                                    <td class="c-calendar__date">23</td>
                                    <td class="c-calendar__date">24</td>
                                </tr>

                                <tr>
                                    <td class="c-calendar__date">25</td>
                                    <td class="c-calendar__date">26</td>
                                    <td class="c-calendar__date">27</td>
                                    <td class="c-calendar__date">28</td>
                                    <td class="c-calendar__date">29</td>
                                    <td class="c-calendar__date">30</td>
                                    <td class="c-calendar__date">
                                    ...
                                    <div class="o-media">
                                        <div class="o-media__img u-mr-xsmall">
                                            <div class="c-avatar c-avatar--xsmall">
                                                <img class="c-avatar__img" src="http://i.pravatar.cc/72?img=41" alt="Adam's Face">
                                            </div>
                                        </div>
                            ...
                            <tr class="c-table__row">
                                ...
                                <td class="c-table__cell">
                                    <div class="o-media">
                                        <div class="o-media__img u-mr-xsmall">
                                            <div class="c-avatar c-avatar--xsmall">
                                                <img class="c-avatar__img" src="http://i.pravatar.cc/72?img=42" alt="Adam's Face">
                                            </div>
                                        </div>
                                        <div class="o-media__body">
                            ...
                            <tr class="c-table__row c-table__row--danger">
                                ...
                                <td class="c-table__cell">
                                    <div class="o-media">
                                        <div class="o-media__img u-mr-xsmall">
                                            <div class="c-avatar c-avatar--xsmall">
                                                <img class="c-avatar__img" src="http://i.pravatar.cc/72?img=44" alt="Adam's Face">
                                            </div>
                                        </div>
                                        <div class="o-media__body">
                                            Stella Munoz
                            ...
                            <tr class="c-table__row">
                                ...
                                <td class="c-table__cell">
                                    <div class="o-media">
                                        <div class="o-media__img u-mr-xsmall">
                                            <div class="c-avatar c-avatar--xsmall">
                                                <img class="c-avatar__img" src="http://i.pravatar.cc/72?img=46" alt="Adam's Face">
                                            </div>
                                        </div>
                                        <div class="o-media__body">
                                            Ellen Santiago
                            ...
                            <tr class="c-table__row">
                                ...
                                <td class="c-table__cell">
                                    <div class="o-media">
                                        <div class="o-media__img u-mr-xsmall">
                                            <div class="c-avatar c-avatar--xsmall">
                                                <img class="c-avatar__img" src="http://i.pravatar.cc/72?img=47" alt="Adam's Face">
                                            </div>
                                        </div>
                                        <div class="o-media__body">
                                            Maurice Briggs
