...
<!-- Mirrored from zawiastudio.com/dashboard/demo/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Nov 2017 15:23:43 GMT -->
<head>
        <meta charset="utf-8">
    ...
    <body class="c-login-wrapper">
        ...
        <div class="c-login">
            <header class="c-login__head">
                ...
                <h1 class="c-login__title">Signup to Get Started</h1>
            </header>
            ...
            <form class="c-login__content">
                ...
                <div class="c-login__social">
                    <a class="c-login__social-icon u-bg-twitter" href="#!" title="Sign-up via Twitter">
                        <i class="fa fa-twitter"></i>
                    </a>

                    <a class="c-login__social-icon u-bg-facebook" href="#!" title="Sign-up via Facebook">
                        <i class="fa fa-facebook"></i>
                    </a>

                    <a class="c-login__social-icon u-bg-pinterest" href="#!" title="Sign-up via Pinterest">
                        <i class="fa fa-pinterest"></i>
                    </a>

                    <a class="c-login__social-icon u-bg-dribbble" href="#!" title="Sign-up via Dribbble">
            ...
            <footer class="c-login__footer">
                <a class="c-login__footer-link u-left" href="#!" title="Terms & Conditions">We care about your privacy, go to our terms & conditions.</a>
            </footer>
        </div>
